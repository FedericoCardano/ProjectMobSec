Java.perform(function () {
    ...
    .implementation = function (mode, key, params) {
        ...
        console.log("Key Encoded: ", key.getEncoded ? key.getEncoded() : "No key encoding");
        console.log("Key Format: " + (key.getFormat ? key.getFormat() : "Unknown key format"));
        ...
        {
            if (key.getEncoded())
                keyContent = toHex(key.getEncoded());
            else
                keyContent = "*unavailable*";
        }
        else
            keyContent = "*missing*";

        console.log("Key: " + keyContent);
